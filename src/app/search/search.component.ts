...
export class SearchComponent implements OnInit {
  query: string;
  results: any;
  constructor(private spotify:SpotifyService, // (a)
  ...
  search():void { // (c)
    ...
    .subscribe((res:any)=> this.renderResults(res)); // (c1)
  }

  renderResults(res:any):void { // (d)
    this.results = null;
  ...
  submit(query:string): void { // (e)
    this.router.navigate(['search'], {queryParams: {
      query: query
    }})
    .then(_ => this.search()); // (e1)
  } 
}
